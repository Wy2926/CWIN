...
public:
    ...
    // Proportional text: font size is a fraction of the pill height so the
    // layout keeps its proportions at any taskbar size / DPI.
    void DrawText(ID2D1DeviceContext* dc, const std::wstring& text, float fontPx,
                  DWRITE_FONT_WEIGHT weight, const D2D1_RECT_F& rect, ID2D1Brush* brush,
...
private:
    ...
    Microsoft::WRL::ComPtr<IDWriteTextFormat> MakeFormat(float fontPx,
